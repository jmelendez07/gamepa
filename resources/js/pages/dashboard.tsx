...
import { Users, Activity, BarChart3, TrendingUp, Rocket } from 'lucide-react';
...
export default function Dashboard({ users, sessions, difficulties, averageProgress, sessionsLastMonth, profilesPerPlanet }: IDashboardProps) {
    ...
    // Transformar datos reales de profilesPerPlanet
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4 overflow-x-auto">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    {/* Gráfica de Sesiones del Último Mes */}
                    ...
                    {/* Gráfica Radial de Progreso por Planeta */}
                    <Card className="border-purple-200 dark:border-purple-900 pb-2">
                        <CardHeader>
                        ...
                        <CardContent>
                            {planetProgress && planetProgress.length > 0 ? (
                                <>
                                    ...
                                    {/* Vista móvil con leyenda debajo */}
