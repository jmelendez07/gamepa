...
import { User, Heart, Zap, Shield, ImageIcon, Upload, Swords, Angry, Globe } from "lucide-react";

interface CreateEnemyModalProps {
    isOpen: boolean;
    onClose: () => void;
    types: EnemyType[];
    planets: Planet[];
...
export default function CreateEnemyModal({ isOpen, onClose, types, planets }: CreateEnemyModalProps) {
        ...
        <Dialog open={isOpen} onOpenChange={handleClose}>
            <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Completa la información para crear un nuevo enemigo en el juego.
                    </DialogDescription>
                </DialogHeader>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <DialogFooter>
                        ...
                        >
                            {processing ? "Creando..." : "Crear Enemigo"}
                        </Button>
                    </DialogFooter>
                </form>
            </DialogContent>
