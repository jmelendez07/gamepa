...
import { Save, User, Heart, Upload, X, Plus, ImagePlus } from 'lucide-react';
import {
    Dialog,
    DialogContent,
    DialogDescription,
...
interface ICreateHeroModalProps {
    isOpen: boolean;
    onClose: () => void;
}

export default function CreateHeroModal({ isOpen, onClose }: ICreateHeroModalProps) {
                ...
                <DialogHeader>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <DialogDescription>
                                Agrega un nuevo héroe a tu colección
                            </DialogDescription>
                        </div>
                    </div>
                </DialogHeader>
